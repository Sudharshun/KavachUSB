 ...
 */
public class CardActivity extends CardboardActivity implements CardboardView.StereoRenderer, OnFrameAvailableListener {
...
//    }
    ...
    public void onClickBackCard(View view) {
        Toast.makeText(CardActivity.this, "CardActivity:Going Back!!! =)",
    ...
    public void onClickGetUpdates(View view) {
        Toast.makeText(CardActivity.this, "CardActivity:Getting Updates!!! =)",
                Toast.LENGTH_LONG).show();
        //Intent intent = new Intent(HomeActivity.this, MainActivity.class);

        Pair<Context, String>[] pairs=new Pair[1];
        pairs[0]=new Pair<Context, String>(this,"TestHUD" );
        // new KavachAsyncTask(SimulationActivity.this).execute(params);
        new HUDAsyncTask().execute(pairs);
        mOverlayView = (CardboardOverlayView) findViewById(R.id.overlay);
        mOverlayView.show3DToast("Checking with KavachHQ for new SitReport");
